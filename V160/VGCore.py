...
class VPlayer:
    ...
    def setPlayerStatus(self,Statut):
        """
        Change l'état du joueur
        """

        if self.testPlayerStatus(Statut):
            self.playerState = Statut
            return True

        return False

    def setPlayerAttrape(self,playerID):
        """
    ...
    def movePos(self, dx=0, dy=0):
        ...
        # Indique que le joueur a été mis à jour, et qu'il peut se déplacer à nouveau
        self.isDirty = False
